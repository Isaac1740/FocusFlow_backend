...
# ================================================
# CREATE TABLES (unchanged schema)
# ================================================
cursor.execute("""
...
def login():
    ...
    for user_id, enc_username, enc_email, hashed_pw in rows:
...
def get_tasks():
    ...
    cursor.execute("""
        ...
        FROM tasks WHERE user_id=%s AND date=%s ORDER BY time ASC
